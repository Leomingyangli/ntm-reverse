...
def get_parser():
    ...
    parser.add_argument('-task_json', type=str, default='ntm/tasks/reverse1.json',
    ...
    parser.add_argument('-config', type=str, default='m1d1',
                        help='choose combinations, m1,m2,m3 for module, d1,d2,d3 for training data')
